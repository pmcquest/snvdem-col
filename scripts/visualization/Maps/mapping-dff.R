...
colwtd <- read_rds("G:/Shared drives/snvdem/snvdem-col/data/panel/final_data/Weighted/col0020-weighted-diff.rds")
...
# 1. Setup
map_directory <- "G:/Shared drives/snvdem/snvdem-col/data/panel/maps/dem-years/diff/" 
file_prefix <- "wf_dem_"
