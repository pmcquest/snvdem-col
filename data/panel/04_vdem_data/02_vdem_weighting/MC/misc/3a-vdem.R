...
# create subset of V-Dem data for 2000-2020
...
# rearrange data into a workable df 
...
###---- Write to rds----
#write_rds(selected_df, file = "G:/Shared drives/snvdem/snvdem-col/data/panel/06_vdem_data/vdem-col0020.rds")
