...
colvars_cdfw <- colvars_cdfw %>%
  ...
  # Directionality is handled by the V-Dem coder weights in 07_weighting.
...
ggsave("G:/Shared drives/snvdem/snvdem-col/data/panel/05_geocoded_panel/imgs/CDF-vars.png", CDF_vars, width = 14, height = 10, dpi = 300, bg = "white")



#---- Write to rds----
write_rds(averages_df, file = "G:/Shared drives/snvdem/snvdem-col/data/panel/05_geocoded_panel/CDF_averages.rds")

# Visualizations ----

# 1. Sample 50 municipalities for the background lines
set.seed(42)
...
ggsave("G:/Shared drives/snvdem/snvdem-col/data/panel/05_geocoded_panel/imgs/CDF-vars_trends.png", trends, width = 14, height = 10, dpi = 300, bg = "white")
...
# 2. Pick 40 random mpios + the 10 biggest jumpers
set.seed(42)
...
# 3. Re-plot using this 'Smart Sample'
