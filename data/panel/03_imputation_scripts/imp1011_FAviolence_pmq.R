...
viol <- readRDS("G:/Shared drives/snvdem/snvdem-col/data/panel/04_imputed_intermediate/imp1011.rds")
...
# Save factor data (will standardize later: z2_merge_imputed_data.R)
write_rds(viol_FA, "G:/Shared drives/snvdem/snvdem-col/data/panel/04_imputed_intermediate/imp1011FA.rds")
