...
# 2026-07-06 reorg: moved from 06_benchmark/02_validate_map.R to 02_diagnostics/01_scripts/
# (renumbered 01_ since 01_benchmark.R now lives in its own 01_benchmark/ subfolder).

library(tidyverse)
library(sf)
library(scales)

master_df <- readRDS("G:/Shared drives/snvdem/snvdem-col/data/panel/06_benchmark/03_output/snvdem_col_benchmarked.rds")
...
ggsave(facet_all_years,
       filename = "G:/Shared drives/snvdem/snvdem-col/data/panel/06_benchmark/02_diagnostics/02_outputs/sndem_final_facet_allyears.png",
...
ggsave(facet_dims,
       filename = "G:/Shared drives/snvdem/snvdem-col/data/panel/06_benchmark/02_diagnostics/02_outputs/sndem_dims_milestone_years.png",
