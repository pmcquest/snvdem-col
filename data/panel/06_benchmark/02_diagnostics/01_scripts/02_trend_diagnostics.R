...
# 2026-07-06 reorg: moved from 06_benchmark/03_trend_diagnostics.R to 02_diagnostics/01_scripts/
# (renumbered 02_ since 01_benchmark.R now lives in its own 01_benchmark/ subfolder).
...
ggsave(p_combined, filename = "G:/Shared drives/snvdem/snvdem-col/data/panel/06_benchmark/02_diagnostics/02_outputs/trend_vs_national_anchors.png",
...
ggsave(p2, filename = "G:/Shared drives/snvdem/snvdem-col/data/panel/06_benchmark/02_diagnostics/02_outputs/global_vs_ipsative_standardization.png",
...
ggsave(p_cl_context, filename = "G:/Shared drives/snvdem/snvdem-col/data/panel/06_benchmark/02_diagnostics/02_outputs/civil_liberties_in_context.png",
