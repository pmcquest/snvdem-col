...
p1 <- range_by_year %>%
  ...
  labs(title = "The national range multiplier is negative in every year (2000-2023)",
       ...
       x = "", y = "Value")
ggsave(p1, filename = "G:/Shared drives/snvdem/snvdem-col/data/panel/06_benchmark/diagnostics/weighted_range_negative_by_year.png",
...
ggsave(p2, filename = "G:/Shared drives/snvdem/snvdem-col/data/panel/06_benchmark/diagnostics/rank_inversion_scatter_2023.png",
