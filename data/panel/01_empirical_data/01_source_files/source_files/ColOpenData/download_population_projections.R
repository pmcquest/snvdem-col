...
library(writexl)
write_xlsx(pop_proj, "G:/Shared drives/snvdem/snvdem24/data/panel/ColOpenData/population_projections.xlsx")
write_xlsx(pop_proje, "G:/Shared drives/snvdem/snvdem24/data/panel/ColOpenData/population_projections_ethnic2018-30.xlsx")
