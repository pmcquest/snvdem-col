...
df06 <- read_rds("G:/Shared drives/snvdem/snvdem-col/data/panel/01_empirical_data/03_clean_outputs/df06_clean.rds") # 15-16
...
imp1516 <- imp1516 %>%
  select(MPIO_CDPMP, year, RulPar_15t16, RulParD_15t16)
write_rds(imp1516, "G:/Shared drives/snvdem/snvdem-col/data/panel/02_imputation/02_imputation_outputs/imp1516.rds")
