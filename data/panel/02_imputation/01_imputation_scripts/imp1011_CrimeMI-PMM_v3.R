...
library(mice)
library(ggplot2)
library(stringr) # NOTE 2026-07-03: added -- str_pad() below with no stringr load always
                 # errored on a fresh run ("could not find function str_pad").
...
#----Save and document----
write_rds(imp1011, "G:/Shared drives/snvdem/snvdem-col/data/panel/02_imputation/02_imputation_outputs/imp1011.rds")
