##----CART (classification and regression trees) via mice----
# NOTE 2026-07-05: this file's name and header used to say "Predictive Mean Matching," but the
# actual mice() call below has used method = "cart", not "pmm", since at least the 2026-07-03
# version -- a real label/code mismatch. Renamed 2026-07-06 (...FiscalPMM... -> ...FiscalCART...)
# and header corrected to match; the method itself was left as-is (CART is a defensible, arguably
# better choice here -- see the imputation methodology memo in 04_diagnostics/).
...
# Save ----
summary(imp23b)
saveRDS(imp23b, "G:/Shared drives/snvdem/snvdem-col/data/panel/02_imputation/02_imputation_outputs/imp23b.rds")
