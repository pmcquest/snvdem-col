...
IR18 <- read_excel("G:/Shared drives/snvdem/snvdem-col/data/panel/CEDE_PM/2022/General/PANEL_CARACTERISTICAS_GENERALES(2021).xlsx", 
...
VAM18 <- read_excel("G:/Shared drives/snvdem/snvdem-col/data/geospatial/2018pmq/2-3_EconDevt/anexo-2020-2021-provisional-valor-agregado-municipio-2011-2021.xlsx", sheet = "Cuadro 9", range = "A11:I1133")
...
PBID18 <- read_excel("G:/Shared drives/snvdem/snvdem-col/data/geospatial/2018pmq/2-3_EconDevt/anex-PIBDep-RetropolacionDepartamento-2022pr.xlsx", sheet = "Cuadro 1", range = "A10:AS36")
PBID18 <- PBID18 %>%
...
##---- 10 Civil unrest ----
CU18 <- read_excel("G:/Shared drives/snvdem/snvdem-col/data/panel/CEDE_PM/2022/Violencia/PANEL_CONFLICTO_Y_VIOLENCIA(2021).xlsx")
CU18 <- CU18 %>%
...
# b) road density
RD18 <- read_csv("G:/Shared drives/snvdem/snvdem-col/data/geospatial/13_Remote/roads_updated.csv")
RD18 <- RD18 %>%
...
write.csv(col18, file = "G:/Shared drives/snvdem/snvdem-col/report/analysis/1_col18_v2.csv", row.names = FALSE)
write.csv(col18e, file = "G:/Shared drives/snvdem/snvdem-col/report/analysis/1_col18e_v2.csv", row.names = FALSE)
