...
write.csv(col18_weights, file = "G:/Shared drives/snvdem/snvdem24/report/analysis/3_weighttable.csv", row.names = FALSE)
...
library(readr)
FAcol18 <- read_csv("G:/Shared drives/snvdem/snvdem24/report/analysis/2_FAcol18.csv")
...
write.csv(FAcol18, file = "G:/Shared drives/snvdem/snvdem24/report/analysis/3_FAcol18.csv", row.names = FALSE)
...
FAcol18 <- read_csv("G:/Shared drives/snvdem/snvdem24/report/analysis/3_FAcol18.csv")
...
ggsave(filename = "G:/Shared drives/snvdem/snvdem24/report/analysis/3Weight_figs/wf_dem18_map.png", 
...
ggsave(filename = "G:/Shared drives/snvdem/snvdem24/report/analysis/3Weight_figs/wf_emel18_map.png", 
       height = 10, width = 10, device = "png", units = "in")
...
ggsave(filename = "G:/Shared drives/snvdem/snvdem24/report/analysis/3Weight_figs/wf_cscw18_map.png", 
       height = 10, width = 10, device = "png", units = "in")
